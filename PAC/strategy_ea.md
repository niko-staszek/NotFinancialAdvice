...
- [§0 Preamble](#0-preamble)
  - [§0.1 Scope & Versioning](#01-scope--versioning)
  - [§0.2 Data Sources & Known Limitations](#02-data-sources--known-limitations)
  - [§0.3 Relation to `strategy.md` / `review.md` / `literature_comparison.md`](#03-relation-to-strategymd--reviewmd--literaturecomparisonmd)
  - [§0.4 Notation Conventions](#04-notation-conventions)
  - [§0.5 Open Questions for v2](#05-open-questions-for-v2)
- [§1 Risk Management](#1-risk-management)
  - [§1.1 Position Sizing](#11-position-sizing)
  - [§1.2 Minimum R:R Gate](#12-minimum-rr-gate)
  - [§1.3 Per-Session Trade Cap](#13-per-session-trade-cap)
  - [§1.4 Daily Drawdown Circuit-Breaker](#14-daily-drawdown-circuit-breaker)
  - [§1.5 Weekly Drawdown Circuit-Breaker](#15-weekly-drawdown-circuit-breaker)
  - [§1.6 Correlated-Pair Lockout](#16-correlated-pair-lockout)
  - [§1.7 News Blackout](#17-news-blackout)
- [§2 Universe & Sessions](#2-universe--sessions)
  - [§2.1 Tradable Instruments](#21-tradable-instruments)
  - [§2.2 Timeframes](#22-timeframes)
  - [§2.3 Polish-Local Session Windows](#23-polish-local-session-windows)
- [§3 Direction Filter](#3-direction-filter)
  - [§3.1 EMA 21 / SMA 61 Sentiment](#31-ema-21--sma-61-sentiment)
  - [§3.2 MMD Cloud Confluence](#32-mmd-cloud-confluence)
  - [§3.3 D1 OHLC Promo Zone](#33-d1-ohlc-promo-zone)
  - [§3.4 Session Box Position](#34-session-box-position)
  - [§3.5 Composite Direction Rule](#35-composite-direction-rule)
- [§4 Entry Trigger](#4-entry-trigger)
  - [§4.1 Signal Candle Definition](#41-signal-candle-definition)
  - [§4.2 EMA-Side Hard Rule](#42-ema-side-hard-rule)
  - [§4.3 Confluence Requirement](#43-confluence-requirement)
- [§5 Target Engine](#5-target-engine)
  - [§5.1 Measured Move (AB=CD with EMA-Cross Anchor)](#51-measured-move-abcd-with-ema-cross-anchor)
  - [§5.2 Fibonacci Levels & Clusters](#52-fibonacci-levels--clusters)
  - [§5.3 Extended Measured Move (138.2% / 161.8%)](#53-extended-measured-move-1382--1618)
  - [§5.4 Settle Buffer](#54-settle-buffer)
- [§6 Setup Recognition](#6-setup-recognition)
  - [§6.1 Trap Setup](#61-trap-setup)
  - [§6.2 Fail Setup](#62-fail-setup)
  - [§6.3 Spike & Channel](#63-spike--channel)
- [§7 Order Management](#7-order-management)
  - [§7.1 SL Placement](#71-sl-placement)
  - [§7.2 Order Type (Market vs Limit)](#72-order-type-market-vs-limit)
  - [§7.3 Optional Partials (off by default)](#73-optional-partials-off-by-default)
  - [§7.4 Optional Trailing Stop (off by default)](#74-optional-trailing-stop-off-by-default)
  - [§7.5 Trade Execution Checklist](#75-trade-execution-checklist)
- [Appendix A — Dropped Components](#appendix-a--dropped-components)
- [Appendix B — Component → strategy.md Mapping](#appendix-b--component--strategymd-mapping)
- [Appendix C — Worked Examples](#appendix-c--worked-examples)
  - [C.1 Example — Mentor XAUUSD SELL with signal-candle entry and MM target](#c1-example--mentor-xauusd-sell-with-signal-candle-entry-and-mm-target)
  - [C.2 Example — Mentor EURUSD SELL plan rejected as forward-looking intent](#c2-example--mentor-eurusd-sell-plan-rejected-as-forward-looking-intent)
  - [C.3 Example — Student US500 SELL evaluated by deterministic gates at the bar moment](#c3-example--student-us500-sell-evaluated-by-deterministic-gates-at-the-bar-moment)
- [Appendix D — Threshold Derivation Methodology](#appendix-d--threshold-derivation-methodology)
  - [D.1 Curriculum-Fixed (No Debate)](#d1-curriculum-fixed-no-debate)
  - [D.2 review.md-Recommended (Where Curriculum Is Silent)](#d2-reviewmd-recommended-where-curriculum-is-silent)
  - [D.3 Industry-Default Risk Rules (Where Neither Curriculum Nor Critique Specifies)](#d3-industry-default-risk-rules-where-neither-curriculum-nor-critique-specifies)
  - [D.4 Data-Anchored (Where Chatdump Supports Specific Tuning)](#d4-data-anchored-where-chatdump-supports-specific-tuning)
  - [D.5 Stub / TBD-After-Backtest (Phase 4 Will Refine)](#d5-stub--tbd-after-backtest-phase-4-will-refine)
