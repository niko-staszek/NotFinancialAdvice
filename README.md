...
| [ORB](ORB/strategy.md) | **Opening Range Breakout** — US session open box with Fair Value Gap (imbalance) retracement entries | US500 / ES | M5 |
...
MMD Clouds (trend / regime filter)
 ...
 +-- ORB can use MMD for directional bias
```
